...
static const char col_red[]         = "#772200";
static const char st_param_z[]      = "11";
...
static Key keys[] = {
    ...
    //                  XF86AudioPrev
    { MODKEY,           XK_F5,      spawn,      { .v = media_previous  } },
    { NULL,             0x1008ff16, spawn,      { .v = media_previous  } },
    //                  XF86AudioNext
    { MODKEY,           XK_F6,      spawn,      { .v = media_next      } },
    { NULL,             0x1008ff17, spawn,      { .v = media_next      } },
    // TAGKEYS
    TAGKEYS(            XK_1,                     0 )
    TAGKEYS(            XK_2,                     1 )
    TAGKEYS(            XK_3,                     2 )
